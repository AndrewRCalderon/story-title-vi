...
.PHONY: all
all: clean-epa-complaints-96-13 clean-epa-complaints-14-23 analysis/output_data/mapped_epa_complaints_1996_2023.csv analysis/output_data/mapped_epa_complaints_2014_2023.csv analysis/output_data/joined_epa_complaints_2014_2023.csv analysis/output_data/appended_epa_complaints_1996_2023.csv
...
analysis/output_data/mapped_epa_complaints_1996_2023.csv: analysis/output_data/epa_cpi_complaints_1996_2013.csv
	${PYENV} python analysis/processors/map_complaint_data_1996_2013.py --file_path=$< --output_path=$@

analysis/output_data/mapped_epa_complaints_2014_2023.csv: analysis/output_data/epa_complaints_2014_2023.csv
	${PYENV} python analysis/processors/map_complaint_data_2014_2023.py --file_path=$< --output_path=$@
...
analysis/output_data/appended_epa_complaints_1996_2023.csv: analysis/output_data/joined_epa_complaints_2014_2023.csv analysis/output_data/mapped_epa_complaints_1996_2023.csv
